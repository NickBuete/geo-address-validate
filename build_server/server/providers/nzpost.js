...
function getNzPostAccessToken(forceRefresh = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const requestToken = () => __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch(NZPOST_TOKEN_URL, {
                method: 'POST',
                headers: {
        ...
        try {
            const token = yield nzPostTokenPromise;
            return token;
        }
        finally {
...
function buildNzPostHeaders(forceRefresh = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const token = yield getNzPostAccessToken(forceRefresh);
        headers.Authorization = token.startsWith('Bearer ') ? token : `Bearer ${token}`;
        return { headers, refreshable: true };
    });
}
function requestNzPostJson(url, forceRefresh = false) {
    return __awaiter(this, void 0, void 0, function* () {
        let headerResult = yield buildNzPostHeaders(forceRefresh);
        if (!headerResult) {
        ...
        if (response.status === 401 && headerResult.refreshable) {
            ...
            headerResult = yield buildNzPostHeaders(true);
            if (!headerResult) {
...
function nzPostDomesticPredict(query) {
    return __awaiter(this, void 0, void 0, function* () {
...
function nzPostAustraliaPredict(query) {
    return __awaiter(this, void 0, void 0, function* () {
...
function nzPostAustraliaDetail(id) {
    var _a, _b, _c, _d, _e;
    return __awaiter(this, void 0, void 0, function* () {
